...
"""LIFO cost basis tracking and gain calculation (uses last purchase price)."""
...
def process_sell_order(conn: sqlite3.Connection, order_id: int, symbol: str,
    ...
    """
    Process a SELL order using LIFO matching against open lots (newest first).
    ...
    # Match by exact symbol (each option contract is tracked separately)
